...
$r=explode("-",$que,2);
$pattern12_array = array('bu'=>'i','sh'=>'r','an'=>'o','ah'=>'u','ir'=>'p','su'=>'g','na'=>'t','ro'=>'l','pk'=>'s','st'=>'x');	

$rev=$pattern12_array[$r[0]];
$reverse=substr($rev,0,1);

        $deco_arr1 = str_split($r[1]);

		$mydecochar = "KLMNOPQSCD6v8TUBVW|XY7zA9tnopklmefgqrEFGHIJ12bhij3Zdu04R5csywxa"; 
