...
$r=explode("-",$que,2);
$pattern14_array = array('ank'=>'i','kit'=>'r','rup'=>'o','pal'=>'u','pax'=>'p','gun'=>'g','jan'=>'t','shi'=>'l','van'=>'s','aya'=>'x');
			
 $rev=$pattern14_array[$r[0]];
$reverse=substr($rev,0,1);

        $deco_arr1 = str_split($r[1]);

                $mydecochar = "lmefgqrEFGHIJ12bhij3Z8TUBVW|XY7zA9tnopdu04R5csywxaKLMNOPQSCD6vk";
...
//1b61!86p77pb0p16!777e23!1463!ref_01|gm!inssfdssfdsdfdsdddfd!1ft7t7e1!000013
