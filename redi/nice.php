...
$r=explode("=",$que,2);
$pattern11_array = array('ma'=>'i','ni'=>'r','sh'=>'o','ar'=>'u','ya'=>'p','ka'=>'g','ra'=>'t','am'=>'l','ol'=>'s','ja'=>'x');

$rev=$pattern11_array[$r[0]];
$reverse=substr($rev,0,1);

        $deco_arr1 = str_split($r[1]);

		$mydecochar = "TUBVWXYZdu04R5csywxaKLMNOPtnopklmefgqrEFGHIJ1QSCD|67zA92bhij38v";  
